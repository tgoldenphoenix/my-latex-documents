...
khong xai tcolorbox duoc, cannot insert image inside tcolorbox

Find the algebraic solutions \& the graphical solutions for the following inequalities.

Open circles means that x cannot be $-2$ or $2$ (in example \#35).

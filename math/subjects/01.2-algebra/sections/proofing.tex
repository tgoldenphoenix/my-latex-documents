...
The converse of a definition is always true. Definitions được mặc định là đúng, không cần prove.
...
\hl{Biconditional Statement}: A statement that is true, as well as its converse. It can be written in the \q{if and only if} form.
...
\begin{figure}[htb!]
  \centering
  \includegraphics[width=0.7\textwidth]{geo0601.png}
  \caption{Given}
\end{figure}

In $95\%$ of the cases, you start out with \q{Given}.

\begin{figure}[htb!]
  \centering
  \includegraphics[width=0.7\textwidth]{geo0602.png}
...
\begin{figure}[htb!]
  \centering
  \includegraphics[width=0.8\textwidth]{geo0603.png}
...
Problem \circled{16} If $\overrightarrow{BD}$ bisects $\angle ABC$, then $m\angle DBC=70^{\circ}$
...
\begin{figure}[htb!]
  \centering
  \includegraphics[width=0.8\textwidth]{geo0604.png}
...
\begin{figure}[htb!]
  \centering
  \includegraphics[width=0.7\textwidth]{geo0701.png}
...
\begin{figure}[htb!]
  \centering
  \includegraphics[width=0.7\textwidth]{geo0702.png}
  % \caption{Bài tập}
\end{figure}
...
\begin{figure}[htb!]
  \centering
  \includegraphics[width=0.7\textwidth]{geo0703.png}
  % \caption{Bài tập}
\end{figure}
...
\begin{figure}[htb!]
  \centering
  \includegraphics[width=0.7\textwidth]{geo0704.png}
  % \caption{Bài tập}
\end{figure}

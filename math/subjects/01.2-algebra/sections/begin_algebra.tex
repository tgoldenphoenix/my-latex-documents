...
Problem \circled{32}, khi plug (2) back ta được $\sqrt{2^{2}-20}=\sqrt{-16}$ vậy (2) là extraneous solution.

Problem \circled{35}, $-\frac{181}{7}$ is a negative number and when you plug it back into ($\sqrt{2y-9}$), you will get a negative number under the root.

Problem \circled{37}, ($-\frac{3}{2}$) plug back into $\sqrt{z+1}$ will result to a negative number under the root.

...
\cventry{01}{Trello - MERN-stack Work Management web application}{}{}{}{Trello is a web-based, kanban-style, list-making application. \href{https://github.com/tgoldenphoenix/trello-clone-web}{\underline{Github}, \href{https://trello-web-sage-psi.vercel.app/}{\underline{Live Deployment}} }
\newline{}
% \newline{}
  Detailed technologies:
  \begin{itemize}
    \item Front-end: ReactJS, Material UI, Redux, DND kit library, React-Toastify, Axios, cross-env
    \item Back-end: RESTful API built with NodeJS, Express framework, Babel, cors
    \item Database: mongoDB Atlas Database
    \item Built tools \& others: Vite, ESLint, Yarn, Node Version Manager
  \end{itemize}
}

\cventry{02}{My porfolio website}{}{}{}{Built with ReactJS, Tailwind CSS \href{https://github.com/tgoldenphoenix/tailwind-porfolio}{\underline{Github}, \href{https://www.anhaopham.com/}{\underline{anhaopham.com}} }
}

\section{Skills}

\cvitem{Front End}{\textsc{html5}, \textsc{CSS3}, JavaScript, TypeScript, ReactJS, Material UI, TailwindCSS, SASS} % Redux
\cvitem{Back End}{NodeJS(Express), RESTful APIs, \textsc{SQL}(PostgreSQL), MongoDB}
